...
while attempts != 0 and len(letter) != 0:
    ...
    if letter == '/help':
        ...
        print('/attempts - показывает количество оставшихся возможностей написать неправильную букву')
    ...
    #Переменная letter проверяется на наличие только одной буквы, наличием ее в слове (регистр не учитывается) и отсутствием ее в переменной unusable_symbols.
