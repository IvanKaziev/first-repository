...
#Дополнительная переменная, нужная для определения повторяющихся букв.
secret_new_res = ''

#Переменная a содержит в себе все цифры и русские буквы для дальнейшего сравнения с ней переменной letter.
...
unusable_symbols = '123456789qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM.!"№;%:?*()_+=@#$%^&\|-'
...
while attemps != 0 and len(letter) != 0:
    ...
    if letter in set(secret_new_res):
        print('Вы уже ввели эту букву! Повторяю:')
